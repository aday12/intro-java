...
/**
 * JR: Works as intended, usage banner needs improvement.
 *  Use GolfClub.MIN_CLUBS and MAX_CLUBS instead of hardcoded 10 and 14,
 *  and typo in 'note2' -> one piece says "10-14" and another says "between 10 & 12."
 */
class GolfClubClientArgs {
    ...
    public static void main(String[] args) {
        ...
        if(args.length < 3){    //check for all inputs
            ...
            String note2 = "The PGA only allows 10-14 clubs in a set on tour, you must have between 10 & 14 clubs.";
