...
//        }
//        else{
//            System.out.println("Brand must be one of the following: " + Arrays.toString(VALID_BRANDS);
//        }
//    }

    private static boolean isValidBrand(String brand) { //if this wasnt static you would need an entire object to check if brand was valid
        boolean valid = false; //can write differently by alternating what code is commented out
